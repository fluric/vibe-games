export const BOT_DESCRIPTIONS: Record<string, Record<string, string>> = {
  mill: {
    ...
    rl_intermediate: "Neural Network (Depth 0)",
    rl_scout: "Neural Network + MCTS 10",
    rl_strategist: "Neural Network + MCTS 25",
    rl_strong: "Neural Network + MCTS 50",
    rl_master: "Neural Network + MCTS 100",
    rl_champion: "Neural Network + MCTS 800",
  },
  connect_four: {
    easy_random: "Random Play",
    easy_cowardly: "Blocked-Avoidance & Defense",
...
export const BOT_HELP_TEXT: Record<string, Record<string, string>> = {
  mill: {
    ...
    rl_novice: "A novice neural network that evaluates the board instantaneously with no lookahead.",
    rl_intermediate: "An intermediate neural network that evaluates the board instantaneously with no lookahead.",
    rl_scout: "A scout neural network utilizing MCTS to search 10 paths.",
    rl_strategist: "A strategic neural network utilizing MCTS to search 25 paths.",
    rl_strong: "An expert neural network utilizing MCTS to search 50 paths.",
    rl_master: "A master neural network utilizing MCTS to search 100 paths.",
