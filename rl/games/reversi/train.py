...
from rl.games.reversi.net import ReversiNet, create_net, load_checkpoint, save_checkpoint, get_device

SCRIPT_DIR = Path(__file__).parent
REPO_ROOT = SCRIPT_DIR.parent.parent.parent
MODELS_DIR = REPO_ROOT / "rl" / "service" / "models" / "reversi"

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train AlphaZero Reversi bot")
    ...
    run_training_loop(
        ...
        game_name="reversi",
        action_space_size=ReversiNet.NUM_ACTIONS,
